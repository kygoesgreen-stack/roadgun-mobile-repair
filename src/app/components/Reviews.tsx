  ...
  return (
    <section id="reviews" className="bg-dark-800 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Matthew Bennett Review */}
          <div className="relative rounded-2xl border border-dark-600 bg-dark-900 p-8 sm:p-10">
            <svg
              className="absolute top-6 left-8 h-10 w-10 text-orange-500/20 sm:h-12 sm:w-12"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <blockquote className="mt-5 text-base leading-relaxed text-steel-200">
              &ldquo;Travis goes above and beyond fixing all my equipment and
              keeping it operational. Highly recommend and used his services on
              multiple different occasions.&rdquo;
            </blockquote>

            <div className="mt-6 flex items-center gap-4">
              <div className="flex h-11 w-11 items-center justify-center rounded-full bg-orange-500/10 text-base font-bold text-orange-400 font-[family-name:var(--font-display)]">
                MB
              </div>
              <div>
                <p className="font-semibold text-white">Matthew Bennett</p>
